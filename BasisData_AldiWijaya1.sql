...
DELIMITER //
create procedure updateDataPelanggan(idpelanggan varchar(10), nama varchar(100), alamat varchar(255), notelp varchar(15))
begin
	
end //
DELIMITER ;
call updateDataPelanggan('PL-BD-002', 'Aldi wijaya', 'Palembang','082212345123');
