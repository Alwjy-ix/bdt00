...
insert into Kamar (IDKamar, TipeKamar, TarifPerKamar, StatusKetersediaan) VALUES
('kam001','Standard',300000,'Tersedia'),
('kam002','Standard',300000,'Tesedia'),
...
('pes003','2026-03-10 10:00:00',1,150000,'tamu03','lay003'),
...
('pes007','2026-03-08 18:00:00',1,100000,'tamu07','lay007'),
...
desc Tamu;
-- menampilkan seluruh data dari tabel anggota  
Select * from Tamu;
...
select IdKamar, TipeKamar From kamar Where TipeKamar = 'Standard';
